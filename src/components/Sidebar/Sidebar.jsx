...
const Sidebar = () => {
  return (
    <div className="mt-6 justify-center item-center ">
      ...
      <div className="bg-gradient-to-r from-yellow-500 via-yellow-400 to-yellow-300 ml-6 mt-6 rounded-lg
...
">
      ...
      <div className="bg-gradient-to-r from-yellow-500 via-yellow-400 to-yellow-300 mt-1 ml-6 rounded-lg">
